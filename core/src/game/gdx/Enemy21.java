...
public class Enemy21 {
    ...
    public void render(Batch batch) {
        ...
        if (TimeUtils.nanoTime() - lastDropTime2 > 844772000L) spawnEnemy22();
        if (TimeUtils.nanoTime() - lastDropTime > 1689544000L) spawnEnemy21();
