...
public class Enemy25 {
    ...
    public void render(Batch batch) {
        ...
        if (TimeUtils.nanoTime() - lastDropTime2 > 844772000L) spawnEnemy30();
        if (TimeUtils.nanoTime() - lastDropTime > 1689544000L) spawnEnemy29();
