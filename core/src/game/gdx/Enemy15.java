...
public class Enemy15 {
    ...
    public void render(Batch batch) {
        ...
        if (TimeUtils.nanoTime() - lastDropTime2 > 1710241823L) spawnEnemy10();
        if (TimeUtils.nanoTime() - lastDropTime > 3420483646L) spawnEnemy9();
