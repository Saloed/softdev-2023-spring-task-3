...
public class Enemy22 {
    ...
    public void render(Batch batch) {
        ...
        if (TimeUtils.nanoTime() - lastDropTime2 > 844772000L) spawnEnemy24();
        if (TimeUtils.nanoTime() - lastDropTime > 1689544000L) spawnEnemy23();
